...
function Table({ rank, name, played, w, d, l, gf, ga, points, id }) {
  ...
  return (
    ...
    >
      ...
      <td className='text-center px-1 py-2 text-center text-xs sm:text-sm md:text-base lg:text-lg xl:text-xl '>({gf}:{ga})</td>
      <td className='text-center px-1 py-2 text-center text-xs sm:text-sm md:text-base lg:text-lg xl:text-xl hidden sm:table-cell'>{gf - ga}</td>

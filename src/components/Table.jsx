...
function Table({ rank, name, played, w, d, l, gf, ga, points, id }) {
  ...
  return (
    ...
    >
      ...
      <td className='text-center p-1 text-center text-xs sm:text-sm md:text-base lg:text-lg xl:text-xl '>{gf}</td>
      <td className='text-center p-1 text-center text-xs sm:text-sm md:text-base lg:text-lg xl:text-xl '>{ga}</td>
      <td className='text-center p-2 text-center text-xs sm:text-sm md:text-base lg:text-lg xl:text-xl hidden sm:table-cell'>{gf - ga}</td>
      <td className='text-center p-2 text-center text-sm sm:text-base md:text-lg lg:text-xl xl:text-2xl' style={{ fontWeight: 'bold' }} data-theme="garden">{points}</td>
    </motion.tr>
  )
}
